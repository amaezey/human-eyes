...
79 patterns to detect and fix, organised by category. Each identifier is a category letter and a position within that category, so a new pattern joins its category without renumbering anything else. Each entry has words to watch, a brief description of the problem, and a before/after example, and carries a **Detection** marker stating whether the pattern is enforced by a programmatic check, folded into another check, or left to manual / agent-judgement reading.
...
**Severity:** strong_warning · `no-forced-triads`
...
**Severity:** strong_warning · `vocabulary-diversity`
...
**Severity:** strong_warning · `no-nominalisation-rate`
...
**Severity:** strong_warning · `no-latinate-verb-rate`
...
**Severity:** strong_warning · `word-length-average`
...
**Severity:** context_warning · `no-parenthetical-headings`
...
**Severity:** hard_fail · `no-knowledge-cutoff-disclaimers`
...
**Severity:** strong_warning · `no-generic-conclusions`
...
**Severity:** strong_warning · `no-tidy-paragraph-endings`

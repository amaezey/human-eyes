...
- **Alternate access URLs:**
  ...
  - browser-rendered canonical page preserved as `snapshots/attachments/anthropic-system-prompts-expanded-2026-07-15.pdf`
- **Author / owner:** Anthropic
- **Publisher:** Anthropic
- **Published:** living release-notes page; the reviewed page contains 28 dated entries from 2024-07-12 through 2026-06-09
- **Retrieved:** 2026-07-15
- **Stable identifier:** none found; living page capture retrieved 2026-07-15
- **Version / revision:** complete first-party Markdown response retrieved 2026-07-15; page content through Claude Fable 5 dated 2026-06-09
- **Extraction method:** direct first-party Markdown endpoint capture from the `.md` URL, checked against the browser-rendered canonical page, a 64-page print-to-PDF capture, PDF text extraction, and raw rendered HTML
- **Full-text status:** complete
- **Access and transformation notes:** The direct first-party Markdown is preserved verbatim below. The documentation wrapper uses escaped XML-like tags, Markdown markup, and Accordion components as returned. For models with multiple dated entries, bold markup identifies release-to-release additions and is treated as documentation diff markup rather than a literal instruction inside the underlying prompt. Bold text in a single-entry prompt may instead be literal prompt emphasis and is not interpreted as a release diff. The rendered PDF is supporting verification evidence, not a replacement for this Markdown source.
...
- **Beginning checked:** The Markdown title, scope paragraph, living-page versioning note, Claude Fable 5 heading, 2026-06-09 date, and opening product-information prompt were compared with the rendered HTML, PDF page 1, and PDF text extraction.
- **Middle checked:** The Claude Sonnet 4.5 section and its 2026-01-18, 2025-11-19, and 2025-09-29 entries were compared across Markdown, rendered HTML, PDF pages 29-37, and extracted PDF text; bolded additions remained identifiable in the Markdown source.
- **End checked:** The Claude Sonnet 3.5, Haiku 3.5, Opus 3, and Haiku 3 sections, including the final 2024-07-12 prompt, were compared with rendered HTML, PDF pages 50-64, and extracted PDF text.
- **Structure checked:** 16 model headings, 28 dated Accordion entries, 2,433 lines of first-party Markdown, and all content through the final closing `AccordionGroup` were present. The 64-page rendered capture and 5,394-line PDF text extraction were checked for beginning/middle/end continuity. The direct Markdown preserves the page's bolded release-diff markup, while PDF rendering confirms expanded prompt bodies rather than loading placeholders.
- **Known omissions:** none from the accessible first-party page. Browser navigation and unrelated page chrome are intentionally absent from the direct Markdown response.

## Preserved attachments

| Path | Role in the source | SHA-256 | Preservation / extraction notes |
|---|---|---|---|
| `snapshots/attachments/anthropic-system-prompts-expanded-2026-07-15.pdf` | Fully expanded browser rendering of the reviewed living page | `64cc53e3685bd71ab93ce011e3316ce0076e26211cee61fbee88fd77be1980ab` | 64-page Chrome print-to-PDF capture; inspected with `pdfinfo`, converted to text, and used to verify beginning, middle, end, and expanded prompt-body continuity. |

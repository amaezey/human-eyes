...
- C04: Replace unsupported `fingerprint` wording with an operational-heuristic label unless separate validation exists.
...
- C09: Preserve the pooled preference and distractor-side nulls.

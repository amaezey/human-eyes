...
| C17: Llama-2 Wikipedia examples add essay-like wrap-ups, explicit conclusion labels, praise, and enduring-legacy claims. | Direct qualitative examples; anecdotal. | Partly covered by #44, #24, #1, and #34. A focused check catches isolated line-initial `In conclusion` but misses `His legacy endures` and other praise variants. | Exact generic-ending and value-judgment variants remain uncovered; academic conclusion headings are look-alikes. | Evaluate variants with quoted, academic, biographical, and deliberate-human controls before changing checks. | pending | not started |
...
- C17: Evaluate conclusion/praise variants with genre and quotation controls before any check change.
...
- C17: not applicable - pending recommendation; no product change.

...
- C15 approved 2026-07-25 via DR-136B: new programmatic #64 flags a document that mixes British and American spellings of the alternating word families. Neither convention is flagged on its own, and words whose American spelling is ordinary British are excluded.
...
- C15: passed - DR-136B asserts #64 failures for `-ise`/`-ize`, `-yse`/`-yze`, `-our`/`-or`, `-re`/`-er`, `-ogue`/`-og`, doubled-l, ae/oe, and one-off mixtures, and passes for each convention used consistently, for surprise/compromise/advertise-class words, and for tyre, cheque, practice, judgment, learned, and program.

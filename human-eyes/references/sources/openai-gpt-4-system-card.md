...
- C07 parked for evaluation 2026-07-17 (DR-150): Mae rules the hedging/explanation-honesty test a real pattern candidate to be designed and evaluated, separating epistemic qualification from unsupported confidence cues; register row DR-150 holds it.
...
- C07: not applicable - outside the 2026-07-17 DR-113 change; regulated-advice conditional language was not collapsed into #23 hedging and the explanation-honesty recommendation remains pending.

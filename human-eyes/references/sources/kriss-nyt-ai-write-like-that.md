...
| C14: Generated prose can overuse tricolons, including three in a little over 100 words and the literary variant `No X. No Y. Just Z.` | Direct count over a viral excerpt plus a quoted Bing example. | #25 now flags adjacent short fragments sharing an opening word, including `Too young. Too single.` and `No family. No calls.`; #9 also surfaces `No X. No Y. Just Z.` The Bing quotation produces three #10 coordinated-list candidates. | The negative-modal/affirmative reversal and other sentence-level tricolon shapes remain outside their proposed programmatic routes. | Keep the approved #25 pair detector; decide the negative-modal/affirmative reversal separately, then address any remaining sentence-level tricolon shapes. | pending | not started |
...
- C14: Keep the approved #25 repeated-fragment pair detector; decide the negative-modal/affirmative reversal separately, then address any remaining sentence-level tricolon shapes.
...
- C14: passed - DR-19A makes `Too young. Too single.`, `No family. No calls.`, and the full source passage fail #25 while `Too young. Still uncertain.` passes; the remaining C14 shapes stay pending.

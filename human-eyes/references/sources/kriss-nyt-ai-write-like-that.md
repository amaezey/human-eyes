...
- C14: passed - DR-19A makes repeated short-fragment pairs fail #25; DR-19B makes the complete `I may not have X. I may not have Y. But I have Z.` frame and its approved contrastive and emphatic variants fail #9 as one candidate; incomplete frames pass; the remaining C14 shapes stay pending.

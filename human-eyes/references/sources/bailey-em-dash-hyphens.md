...
- C09: not applicable - pending source-record recommendation; focused live checks found one ordinary em dash failed while two candidates in a formal-report example were retained as candidates but context-suppressed; no product change requested.

...
- C16: not applicable - pending source-record recommendation; exact surface-only run flagged #49 once, #56 once on `honestly:`, and #17 for 11 curly glyphs, while #19 returned clear and folded #21 has no separate check.

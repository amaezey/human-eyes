...
- #10 `no-forced-triads` and #10a `no-triad-density`
...
- Should stylized Unicode letters and the multiplication sign be evaluated as #31a candidates with non-English, mathematical, accessibility, quoted, and social-platform controls?
...
| C15: Stylized Unicode bold/italic letters, arrows, and multiplication signs can look machine-formatted, with an explicit non-English/social-platform human-use caveat. | Direct practitioner observation and human look-alike; no frequencies. | Partly covered. Exact surface-only sample made #31a meet threshold on `→` and three emojis, but missed the stylized bold letters, stylized italic letters, and `×`. | Unicode-script, mathematical, accessibility, quotation, and platform controls are required before expansion. | Evaluate the missed variants under #31a with those controls; no immediate regex change. | pending | not started |
...
- C10: Add source provenance for #10/#10a examples with human-rhetoric controls.
...
- C15: Evaluate stylized letters and `×` under #31a with international, mathematical, accessibility, quotation, and platform controls.
...
- C11: not applicable - recommendation pending; no product change requested.
- C12: not applicable - recommendation pending; no product change requested.
- C13: not applicable - recommendation pending; no product change requested.
- C14: not applicable - recommendation pending; no product change requested.
- C15: not applicable - recommendation pending; no product change requested.

...
- C09 approved 2026-07-18 via DR-125: #7 now recognises `firstly`; `additionally` and the existing conclusion-scoped `overall` check were already covered.
...
- C09: passed - DR-125 adds exact #7 recognition for `firstly`; `additionally` and the conclusion-scoped `overall` check remain covered.

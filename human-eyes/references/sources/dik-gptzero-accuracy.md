...
- `human-eyes/references/sources/pattern-opportunities.md`: pending graduated-provenance and human-edit/co-writing evaluation lanes from stronger direct sources; this paper adds no mixed-text result.

...
- C07: passed - DR-02's span-based longest-match counting returns two matches for `unparalleled` plus `invaluable`, leaving the fixture below #7's threshold.

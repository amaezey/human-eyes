...
|---|---|---|---|---|---|---|
| C01: Ten throat-clearers stage a claim before stating it. | Direct catalogue judgment with exact examples; no rate, model, corpus, or human control. | partly covered: #42 finds three examples and #56 finds `I'll be honest`, so 4 of 10 isolated examples fail. | Six spoken openers remain unrecognized; #50 covers a different abstraction-opener family. | **test-adapt:** evaluate a social/marketing opener extension with direct-claim rewrites and legitimate conversational controls; verify with focused fixtures and held-out genre controls. | pending | not started |
...
| C04: Ten binary-contrast templates stage an X-to-Y reversal. | Direct catalogue examples; no frequency or human comparison. | partly covered: #9 finds 5 of 10; one also reaches #42 and signal stacking. | Stop/start, future replacement, most-people/actually, dead/next, and forget/focus variants are incomplete. | **test-adapt:** test syntactic #9 extensions against purposeful contrast, correction, quotation, and argument controls before any regex change. | pending | not started |
...
- C01: test-adapt social/marketing throat-clearers with matched conversational controls before extending #42 or #56.
...
- C04: test-adapt missing #9 syntactic variants with purposeful-contrast controls.
...
- C18: not applicable - recommendation pending; no product change made.
- C19: not applicable - recommendation pending; no product change made.

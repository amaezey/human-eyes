...
- C14 approved 2026-07-19 via DR-20A: #39 now recognises `Insert Table 1 here` and equivalent numbered publishing instructions as hard-fail residue.
...
- C14: Keep numbered publishing instructions in #39.
...
- C14: passed - DR-20A makes `Insert Table 1 here` fail #39 while ordinary finished prose remains clear; all grader tests pass.

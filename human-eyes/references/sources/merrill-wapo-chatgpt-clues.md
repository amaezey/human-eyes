...
- C06: **test-adapt** `delve` against current matched model/register evidence and date-stamp the source mapping.
...
- C06: not applicable - recommendation pending; existing #7 mapping marked review required.

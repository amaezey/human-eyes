...
## Position (2026-07-17 end of session)

Decided and fully closed through question 17: rows DR-01..11, DR-39/40, DR-43, DR-06/07/08/09, DR-111 (journalism watchlist), DR-112 (poetry watchlist), DR-113 (#19 residue families), DR-114 (components 1-2 implemented, 3-4 declined; card write-back was in flight — verify committed). Open items mid-flight: the Caroll answers (DR-106: "Sunday" misquote fix approved and not yet applied — true source passage is in the card snapshot, "the way your coffee smells before you even take a sip"; causal wording ruled leave-as-is; mapping removals held pending verification they are claimed-support rather than adjacency). Next open row after that: DR-115 (structure, lists, and headers). Retirements DR-12/13/29 need verification against their cards before being asked. The POS-01/POS-02 list waits on Mae's tagger from another project.

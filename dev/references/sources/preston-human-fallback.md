...
- `dev/references/sources/pattern-opportunities.md` explicitly removes Preston's inherited #30/#36/#37 mappings and retains human-fallback, script-break, and missing-specifics process guidance. The non-promotion is correct and remains pending rather than implemented product evidence.

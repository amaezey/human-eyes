...
This is the authoritative review table. Focused B1 results below came from the live `human-eyes/scripts/grade.py::check_ai_vocabulary` implementation on 2026-07-17; they are surface-only coverage checks, not complete Audits. Every recommendation remains a pending decision for Mae.
...
- C03: **do not adopt** a B1 expansion or threshold claim from the six attributed examples; route evidence to direct upstream cards.

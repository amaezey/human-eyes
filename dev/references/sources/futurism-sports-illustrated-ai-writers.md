...
- `dev/references/sources/pattern-opportunities.md` promotes Futurism under source-grounding, fact-checking, and claim verification for #41 journalism/academic manual checks.

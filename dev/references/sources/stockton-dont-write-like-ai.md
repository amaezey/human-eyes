...
- **C14:** Part 1 contains no countdown-negation form of the #33 “It wasn't X. It wasn't Y. It was Z.” type and no false-balance/concession claim.
...
- #10 and #49: adjacent co-occurring triplet/em-dash observations only; no isolated effect evidence.
- #33, #23a, #22, and #7: not supported by this reviewed source.
...
- **Removed from current evidence:** uncaptured later-post red-flag words/phrases, vague-change intros, #7, #22, #23a, and #33 mappings.
- **Unchanged:** the canonical article prose, its broad relevance to #9 contrastive negation, its adjacent relevance to #48 density, and its warning against universal bans.

## Decision history

- The legacy record had no claim IDs, user-decision states, or implementation states. It mapped the source to #9/#23a/#48/#22/#7, explicitly said #33 was unsupported, and cited later search excerpts without preserving their full text.
...
- **Findings resolved:** First pass resolved four material findings and one non-material finding: restored the exact em-dash fixture and reran coverage; separated isolated #42/#43 checks from the full-fixture #42 hit; corrected C12 to partly covered; added the omitted dated trend/automation observations with no-baseline/no-causality boundaries; and gave C09 an explicit coverage label. Provenance was also tightened for the video's 660/661-second metadata discrepancy and upload date. The same reviewer returned no findings on focused re-check and stated, “VERDICT: passed — no unresolved findings.”

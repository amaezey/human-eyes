...
- **Canonical URL:** https://www.nplusonemag.com/issue-47/essays/an-age-of-hyperabundance/
- **Alternate access URLs:**
  - none
- **Author / owner:** Laura Preston
- **Publisher:** n+1
- **Published:** Spring 2024; first-party page metadata records 2024-04-10T11:43:08-04:00
- **Retrieved:** 2026-07-17
- **Stable identifier:** n+1 WordPress post ID 54298
- **Version / revision:** first-party page revision modified 2024-06-17T13:25:25-04:00
- **Extraction method:** direct HTML downloaded with `curl`; title, dek, hero caption, `.issue-content-post-body .post-wrapper`, 150 top-level paragraphs, and one substantive three-paragraph blockquote extracted with Beautiful Soup 4 and converted to Markdown with `html2text`
- **Full-text status:** complete
- **Access and transformation notes:** public page loaded without a login, paywall, bot challenge, or truncation. The raw HTML is preserved as an attachment. Four duplicated pullquote/Twitter-share widgets were omitted; each quoted sentence remains in its original body paragraph. The separate three-paragraph Spanish operator-script blockquote was retained. HTML emphasis became Markdown emphasis, decorative drop-cap spans were flattened, and horizontal section dividers were retained.

## Full text

**Dek:** At the conversational AI conference

**Hero image caption:** Dana Lok,  _Typist._ 2023, oil on canvas. 20 × 17”. Courtesy of the artist and Miguel Abreu Gallery, New York.
...
The magazine in question was this one. Bradley had read my essay “HUMAN_FALLBACK” in _n+1_ ’s Winter 2022 issue in which I described my year impersonating a chatbot for a real estate start-up. A lonely year, a depressing charade; it had made an impression on Bradley. He asked if I’d attend Project Voice as the “honorary contrarian speaker,” a title bestowed each year on a public figure, often a journalist, who has expressed objections to conversational AI. As part of my contrarian duties, I was to close out the conference with a thirty-minute speech to an audience of five hundred — a sort of valedictory of grievances, I gathered.
...
“What I see is a lot of leaders that are either NOBLE . . . or _savage_ ,” he bellowed. “I see a lot of communities __ that are either SAVAGE . . . or _noble_. How do you balance savagery, confidence, intensity, drive . . . being the IMPETUS! The DRIVING FORCE THAT MAKES THINGS HAPPEN! . . . with? Nobility. Meekness. Kindness. Love. Care. Empathy. And _sympathy_. And congratulations, when I look at this industry I see a lot of nobility. I often wonder, ‘Where’s the savagery, everybody?’ Are your customers savage about you? About your products? Your services? ARE YOUR EMPLOYEES SAVAGE? WILL THEY KNOCK DOWN WALLS TO MAKE THINGS HAPPEN FOR YOU?”

I found Ian’s LinkedIn. In fact he did have a history with the Evangel­ical church. He was the “entrepreneur-in-residence” at Transform Our World, a global ministry led by the Argentinean evangelist Ed Silvoso, and had been a guest on a panel called “How the Church Can Glorify God in the Metaverse.”
...
“Collapse of context,” I wrote in my notebook. “The ChatGPT-like impulse to write a speech on the noble savage because _noble savage_ is something you’ve heard before, and it sounds badass.”
...
I wasn’t sure how wise it was to solicit health advice from a meta­human whose creators hadn’t mastered human anatomy, but she was, after all, wearing a stethoscope. Norrie shushed me.

“Don’t tell her about your ailments,” he said. “That’s very __ personal. Cathy, who are you with today?”
...
“When I was a kid, this news story came on TV,” he said. “That guy. Jim Jones. He took those people to Guyana and made them eat poison. My buddies and I were watching that and thinking, _Where did all those stupid people come from?_ But you know what? I don’t wonder about that anymore.”
...
“Was it like that movie _M3GAN_?” my Lyft driver asked.
...
- **Beginning checked:** source top-level paragraphs 1-3 begin with the room of men, Project Voice, and Preston's prior `HUMAN_FALLBACK` essay; these matched the rendered first-party page and preserved HTML.
- **Middle checked:** source top-level paragraphs 74-77 cover the reported VERA euthanasia exchange; these matched the rendered first-party page and preserved HTML. The separate three-paragraph Spanish operator-script blockquote after top-level paragraph 32 was also matched to the rendered page, preserved HTML, and archive.
- **End checked:** source top-level paragraphs 148-150 cover the airport arrival, the driver's final question, and Preston and Sarah at the airport bar; these matched the rendered first-party page and preserved HTML.
- **Structure checked:** title, dek, hero caption, 150 substantive top-level paragraphs, one substantive blockquote containing three repeated operator-script paragraphs, 16 section dividers, and all beginning/middle/end sections were checked. The page has no source footnotes, tables, appendix, or reference list. Four pullquote/share widgets duplicate body sentences and were excluded from the substantive count.
- **Known omissions:** decorative page chrome, navigation, subscription appeal, related-article cards, and four duplicate pullquote/Twitter-share widgets only; no substantive article text omitted.

## Preserved attachments

| Path | Role in the source | SHA-256 | Preservation / extraction notes |
|---|---|---|---|
| `snapshots/attachments/preston-hyperabundance-nplusone-post-54298-2026-07-17.html` | Complete first-party HTML response for n+1 post 54298 | `633be41de992b9381bdbf5d674caab91657b69cf6b84e7a2e450c9cde4432220` | Downloaded directly from the canonical URL on 2026-07-17; the article wrapper supplies the complete text, metadata, hero caption, 150 top-level paragraphs, one substantive three-paragraph blockquote, four duplicate pullquote widgets, and 16 section dividers. |

...
- The 2026-05-05 card had no claim IDs, user decisions, implementation statuses, snapshot digest, update provenance, or independent source-record review. Its H3, D3, and model-version notes are reopened and qualified here. No prior approved or implemented product decision exists.
...
- C09 and C11 approved 2026-07-17 via DR-113: commit 340ea99 added apology-led refusal ("I'm sorry, but I can't") and AI-identity disclaimer ("As an AI language model") patterns to D1 `no-collaborative-artifacts`. The regulated-advice-disclaimer component was not collapsed into E2 hedging; C07's explanation-honesty recommendation and C10's genre/quotation/deliberate-use control requirements remain pending.
- C07 approved 2026-07-17 (DR-150): Mae ruled the hedging pattern real and resolved it as a E2 watch-list expansion; six reflexive qualifier cues joined the density count in commit 26847aa. The separate explanation-honesty judgement record and basis-screened programmatic check were declined.
- C05 rejected 2026-07-18 via DR-122: closed-domain source comparison and open-domain factual verification were both declined. The existing closed-record preservation rules remain; no factuality judgement or product change was added.

## Project coverage

This is the authoritative review table. Decision status is recorded per row.
...
- C09: Test apology and AI-identity refusal macros with controlled fixtures before any D1 change.
...
- C05: not applicable - rejected 2026-07-18 via DR-122; closed-domain comparison and open-domain verification were declined, with no product change.
- C06: not applicable - pending source-record recommendation; no product change implemented.
- C07: passed - DR-150 resolved 2026-07-17 as a E2 `no-excessive-hedging` watch-list expansion in commit 26847aa (may vary, in most cases, it depends, in general, as a rule, more often than not); `python3 dev/evals/tests/test_grade.py` passes the DR-150 block including under-threshold controls. The explanation-honesty judgement record and a basis-screened programmatic check were declined, and regulated-advice conditional language stays outside E2.
- C08: not applicable - pending source-record recommendation; no product change implemented.
- C09: passed - commit 340ea99 (DR-113) added apology-led refusal and AI-identity disclaimer patterns to D1 `no-collaborative-artifacts`; `python3 dev/evals/tests/test_grade.py` passes the DR-113 assertions on 2026-07-17.
- C10: not applicable - pending source-record recommendation; no product change implemented.
- C11: passed - commit 340ea99 (DR-113) implemented the rubric-derived apology and AI-identity candidates in D1 `no-collaborative-artifacts`, verified by `python3 dev/evals/tests/test_grade.py` on 2026-07-17; the regulated-advice-disclaimer component was not collapsed into E2 hedging and remains pending.

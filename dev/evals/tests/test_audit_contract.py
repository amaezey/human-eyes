#!/usr/bin/env python3
"""Tests the audit-format-v1 contract emitted by human-eyes/scripts/grade.py human_report().
...
human-eyes/scripts/contracts/audit-format-v1.json is the authoritative shape and is
